...
namespace BattleshipLite
{
    class program
    {
        ...
        private static void DisplayShotGrid(PlayerInfoModel activePlayer) // I added this here and not in the library because it is going to display to the console
        {
